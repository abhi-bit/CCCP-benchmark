...
from memcacheConstants import CMD_STREAM_REQ
from memcacheConstants import CMD_STREAM_END
from memcacheConstants import CMD_MUTATION
from memcacheConstants import CMD_DELETION
from memcacheConstants import CMD_OPEN
from memcacheConstants import CMD_CLOSE_STREAM
from memcacheConstants import CMD_SNAPSHOT_MARKER
from memcacheConstants import CMD_GET_FAILOVER_LOG
from memcacheConstants import CMD_GET_CLUSTER_CONFIG
from memcacheConstants import CMD_FLOW_CONTROL
from memcacheConstants import CMD_DCP_ACK
from memcacheConstants import CMD_QUIT
from memcacheConstants import REQ_PKT_FMT
from memcacheConstants import RES_MAGIC_BYTE
from memcacheConstants import FLAG_OPEN_CONSUMER
from memcacheConstants import FLAG_OPEN_PRODUCER
from memcacheConstants import FLAG_OPEN_NOTIFIER
from memcacheConstants import CMD_ADD_STREAM
...
class DCPClient(MemcachedClient):
    ...
    def get_cluster_config(self, vbucket):
        """ get cluster config """

        op = GetClusterConfig(vbucket)
        return self._handle_op(op)
...
class DCPStream(object):
    ...
    def has_response(self):
        """ true if END has not been received or
        timeout waiting for items in recv queue """
...
class Operation(object):
    ...
    def formated_response(self, opcode, keylen, extlen, status, cas,
                          body, opaque):
...
class GetClusterConfig(Operation):
    """ GetClusterConfig spec """

    def __init__(self, vbucket):
        opcode = CMD_GET_CLUSTER_CONFIG
        Operation.__init__(self, opcode,
                           vbucket=vbucket)
